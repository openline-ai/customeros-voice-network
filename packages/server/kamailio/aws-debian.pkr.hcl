...
build {
  ...
  provisioner "shell" { 
	  inline=  [
	    "sudo sh -c 'rm -rf /var/lib/apt/lists/* && apt-get update &&   DEBIAN_FRONTEND=noninteractive apt-get install -qq --assume-yes gnupg wget collectd'",
	    ...
	    "sudo sh -c 'apt-get update &&   DEBIAN_FRONTEND=noninteractive apt-get install -qq --assume-yes kamailio=5.5.7+bpo11 kamailio-autheph-modules=5.5.7+bpo11 kamailio-berkeley-bin=5.5.7+bpo11 kamailio-berkeley-modules=5.5.7+bpo11 kamailio-cnxcc-modules=5.5.7+bpo11 kamailio-cpl-modules=5.5.7+bpo11 kamailio-dbg=5.5.7+bpo11 kamailio-erlang-modules=5.5.7+bpo11 kamailio-extra-modules=5.5.7+bpo11 kamailio-geoip-modules=5.5.7+bpo11 kamailio-geoip2-modules=5.5.7+bpo11 kamailio-ims-modules=5.5.7+bpo11 kamailio-json-modules=5.5.7+bpo11 kamailio-kazoo-modules=5.5.7+bpo11 kamailio-ldap-modules=5.5.7+bpo11 kamailio-lua-modules=5.5.7+bpo11 kamailio-lwsc-modules=5.5.7+bpo11 kamailio-memcached-modules=5.5.7+bpo11 kamailio-mongodb-modules=5.5.7+bpo11 kamailio-mono-modules=5.5.7+bpo11 kamailio-mqtt-modules=5.5.7+bpo11 kamailio-mysql-modules=5.5.7+bpo11 kamailio-nth=5.5.7+bpo11 kamailio-outbound-modules=5.5.7+bpo11 kamailio-perl-modules=5.5.7+bpo11 kamailio-phonenum-modules=5.5.7+bpo11 kamailio-postgres-modules=5.5.7+bpo11 kamailio-presence-modules=5.5.7+bpo11 kamailio-python-modules=5.5.7+bpo11 kamailio-python3-modules=5.5.7+bpo11 kamailio-rabbitmq-modules=5.5.7+bpo11 kamailio-radius-modules=5.5.7+bpo11 kamailio-redis-modules=5.5.7+bpo11 kamailio-ruby-modules=5.5.7+bpo11 kamailio-sctp-modules=5.5.7+bpo11 kamailio-secsipid-modules=5.5.7+bpo11 kamailio-snmpstats-modules=5.5.7+bpo11 kamailio-sqlite-modules=5.5.7+bpo11 kamailio-systemd-modules=5.5.7+bpo11 kamailio-tls-modules=5.5.7+bpo11 kamailio-unixodbc-modules=5.5.7+bpo11 kamailio-utils-modules=5.5.7+bpo11 kamailio-websocket-modules=5.5.7+bpo11 kamailio-xml-modules=5.5.7+bpo11 kamailio-xmpp-modules=5.5.7+bpo11'",
	    "sudo sh -c 'DEBIAN_FRONTEND=noninteractive apt-get install -qq --assume-yes libpq5 python3-psycopg2 python3-phonenumbers'",
	    "mkdir /tmp/kamailio/",
	  ]
  }
  ...
  provisioner "shell" {
    inline=  [
      ...
      "sudo sh -c 'cd /tmp/;curl https://s3.amazonaws.com/amazoncloudwatch-agent/debian/amd64/latest/amazon-cloudwatch-agent.deb -O; dpkg -i amazon-cloudwatch-agent.deb'",
      "sudo sh -c 'cd /tmp/; cp /tmp/kamailio/logging/amazon-cloudwatch-agent.json /opt/aws/amazon-cloudwatch-agent/etc/'",
